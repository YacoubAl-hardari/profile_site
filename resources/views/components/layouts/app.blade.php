...
<link rel="icon" type="image/png" sizes="16x16" href="{{ asset('favicon-16x16.png') }}">
  ...
  <meta name="keywords" content="@yield('meta_keywords')">
    ...
    <meta property="og:site_name" content="ycigroup">
    <meta property="og:title" content="@yield('meta_title')">
    <meta property="og:description" content="@yield('meta_description')">
    <!-- Image to display -->
    ...
    <meta property="og:url" content="https://www.ycigroup.net/">
  ...
  <link rel="stylesheet" href="{{ asset('front/assets/fontawsome/css/all.min.css') }}">
  <link rel="stylesheet" href="{{ asset('front/assets/fontawsome/css/fontawesome.min.css') }}">
...
<body>
  ...
  <div id="page-content" @if (app()->getLocale() === 'en') dir="ltr" @else dir="rtl" @endif>
    <!-- header part start -->
      ...
      <nav class="navbar">
        <div class="container">
          <div class="menu-container">
            <div class="logo">
              <a class="navbar-brand me-0" wire:navigate href="{{ route('home') }}">
                
                <span class="">يعقوب الحيدري</span>
              </a>
            </div>
            <div class="navbar-main d-flex flex-grow-1">
              ...
              @endphp
              <ul class="mx-auto navbar-info">
                <li class="nav-item">

                  <a  @if ( $routeName == "home")  class="nav-link active" @else class="nav-link"  @endif  aria-current="page" wire:navigate href="{{ route('home') }}">
                    ...
                    <span>{{trans('navs.Home')}}</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a  @if ( $routeName == "about")  class="nav-link active" @else class="nav-link"  @endif wire:navigate href="{{ route('about') }}">
                ...
                <li class="nav-item">
                  <a  @if ( $routeName == "services")  class="nav-link active" @else class="nav-link"  @endif wire:navigate href="{{ route('services') }}">
                ...
                <li class="nav-item">
                  <a  @if ( $routeName == "portfolios" || $routeName == "portfolios-details")  class="nav-link active" @else class="nav-link"  @endif wire:navigate href="{{ route('portfolios') }}">
                    ...
                    {{trans('navs.Portfolios')}}
                  </a>
                </li>
                <li class="nav-item">
                  <a @if ( $routeName == "blogs" || $routeName == "blog-detilas")  class="nav-link active" @else class="nav-link"  @endif wire:navigate href="{{ route('blogs') }}">
                ...
                <li class="nav-item">
                  <a @if ( $routeName == "contact-us")  class="nav-link active" @else class="nav-link"  @endif  wire:navigate href="{{ route('contact-us') }}">
                    <svg class="nav-icon" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="header-right-info d-flex align-items-center">
                ...
                <button class="theme-control-btn">
                  ...
                  <span class="light">
                    ...
                    <small class="theme-text d-block d-xl-none">تغير المظهر</small>
                  </span>
                </button>


                <div class="mx-2 dropdown open">
                
                   
                    @foreach (config('app.support_langs') as $lang => $data)
                      <a wire:navigate href="{{ route('lang-swicher', $lang) }}" class="mx-2">
                          <x-dynamic-component :component="'flag-country-' . $data['icon']" style="width: 25px;" />
  ...
  <div class="background-shapes">
    <div class="shape-1 common-shape">
      <img src="{{ asset('front/assets/img/bg/banner-shape-1.png') }}" alt="banner-shape-1">
    </div>
    <div class="shape-2 common-shape">
      <img src="{{ asset('front/assets/img/bg/banner-shape-1.png') }}" alt="banner-shape-1">
    </div>
    <div class="threed-shape-1 move-with-cursor" data-value="1">
      <img src="{{asset('front/assets/img/bg/object-3d-1.png')}}" alt="object-3d-1">
    </div>
    <div class="threed-shape-2 move-with-cursor" data-value="1">
      <img src="{{asset('front/assets/img/bg/object-3d-2.png')}}" alt="object-3d-2">
    </div>
  </div>
    ...
    <footer class="footer-area">
        <div class="container">
          <div class="text-center text">
            <p>صنع بكل حب <a href="#">يعقوب الحيدري</a></p>
          </div>
        </div>
      </footer>
      <!-- footer part end -->
